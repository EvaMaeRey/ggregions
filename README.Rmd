...
[Link to RMedicine Talk](https://evamaerey.github.io/mytidytuesday/2026-04-03-r-medicine-ggregions/r-medicine-ggregions.html#1)
...
### i. Effortlessly write new geom_* region-specific functions
...
Then, authors will be able use `write_geom_region()` to create a regions-specific ggplot2 layer, for example `geom_us_state()` below, which can be made available in their geo packages.
